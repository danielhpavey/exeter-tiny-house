  ...
  return (
    <div className='flex flex-col min-h-screen font-sans text-gray-700'>
      ...
      <menu className={`${
        ...
        <span className="inline-block "><Link href='/membership'><a className="tiny-menu">Membership</a></Link></span>
        <span className="inline-block "><Link href='/newsletter'><a className="tiny-menu">Newsletter</a></Link></span>
